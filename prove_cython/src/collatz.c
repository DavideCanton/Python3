...
/* "..\..\..\..\..\..\Program Files\Python 3.5\lib\site-packages\Cython\Includes\numpy\__init__.pxd":725
 ...
 * def collatz(int n):
 */
typedef __pyx_t_5numpy_int_t __pyx_t_7collatz_DTYPE_t;
#if CYTHON_CCOMPLEX
  #ifdef __cplusplus
...
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_7collatz_DTYPE_t = { "DTYPE_t", NULL, sizeof(__pyx_t_7collatz_DTYPE_t), { 0 }, 0, IS_UNSIGNED(__pyx_t_7collatz_DTYPE_t) ? 'U' : 'I', IS_UNSIGNED(__pyx_t_7collatz_DTYPE_t), 0 };
...
static char __pyx_k_C_Users_Davide_Documents_workspa[] = "C:\\Users\\Davide\\Documents\\workspace\\Python3\\prove_cython\\src\\collatz.pyx";
...
static PyObject *__pyx_pf_7collatz_collatz(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_n); /* proto */
...
/* Python wrapper */
static PyObject *__pyx_pw_7collatz_1collatz(PyObject *__pyx_self, PyObject *__pyx_arg_n); /*proto*/
static PyMethodDef __pyx_mdef_7collatz_1collatz = {"collatz", (PyCFunction)__pyx_pw_7collatz_1collatz, METH_O, 0};
static PyObject *__pyx_pw_7collatz_1collatz(PyObject *__pyx_self, PyObject *__pyx_arg_n) {
  int __pyx_v_n;
  int __pyx_lineno = 0;
  ...
  __pyx_r = __pyx_pf_7collatz_collatz(__pyx_self, ((int)__pyx_v_n));
...
static PyObject *__pyx_pf_7collatz_collatz(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_n) {
 ...
 */
  ...
  __pyx_t_4 = ((PyArrayObject *)__pyx_t_3);
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_b.rcbuffer->pybuffer, (PyObject*)__pyx_t_4, &__Pyx_TypeInfo_nn___pyx_t_7collatz_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) {
 ...
 */
    ...
    *__Pyx_BufPtrStrided1d(__pyx_t_7collatz_DTYPE_t *, __pyx_pybuffernd_b.rcbuffer->pybuffer.buf, __pyx_t_6, __pyx_pybuffernd_b.diminfo[0].strides) = __pyx_v_n;
 ...
 */
  ...
  *__Pyx_BufPtrStrided1d(__pyx_t_7collatz_DTYPE_t *, __pyx_pybuffernd_b.rcbuffer->pybuffer.buf, __pyx_t_8, __pyx_pybuffernd_b.diminfo[0].strides) = 1;
 ...
 */
  ...
  __pyx_codeobj__9 = (PyObject*)__Pyx_PyCode_New(1, 0, 4, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__8, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_C_Users_Davide_Documents_workspa, __pyx_n_s_collatz, 9, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#endif
{
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "collatz")) {
      if (unlikely(PyDict_SetItemString(modules, "collatz", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *     cdef int i = 0
 */
  __pyx_t_2 = PyCFunction_NewEx(&__pyx_mdef_7collatz_1collatz, NULL, __pyx_n_s_collatz); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init collatz", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
